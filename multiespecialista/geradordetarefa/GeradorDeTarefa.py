...
class GeradorDeTarefa(object):
    ...
    def fatoracao(self):
        n = random.randint(1, 100)  # Escolhe um número aleatório entre 1 e 100
        fatores = sympy.factorint(n)  # Retorna um dicionário com a decomposição em fatores primos
        return n, fatores  # Ex: 60 → {2: 2, 3: 1, 5: 1}
